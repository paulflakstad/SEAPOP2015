...
public List<MenuItem> getBreadCrumbItems(Menu menu, CmsAgent cms, String resourceUri) throws org.opencms.loader.CmsLoaderException, CmsException {
    ...
    final String HOME_URI = cms.link(cms.property("home-file", "search", "/".concat(loc).concat("/")).replace("/index.html", "/"));
    ...
    if (menu.getElementByUrl(resourceUri) == null) {
        ...
        //*/
        // This is the standard routine for handling loose files, that is, when the current page is not in the menu.
