...
public String getImageContainer(CmsAgent cms, 
    ...
    String imageFrameHTML =
            ...
            + "\""
            + (imageStyle.isEmpty() ? "" : " style=\"".concat(imageStyle).concat("\""))
            + ">"
            + imageTag;
...
try {
    ...
    while (paragraphs.hasMoreResources()) {
        paragraphCounter++;
        ...
        try {
            ...
            while (imageContainer.hasMoreContent()) {
                ...
                if (!CmsAgent.elementExists(imageStyle))
                        imageStyle = null;
        ...
        try {
            ...
            if (CmsAgent.elementExists(extFile)) {
                ...
                try {
                    ...
                    if (getParameters(extFile).get("folder") != null) {
    ...
    out.println("<p>Exception:</p><p>" + getStackTrace(eee) + "</p>");
}
